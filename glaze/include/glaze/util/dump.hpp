...
namespace glz::detail
{
   ...
   template <uint32_t N, is_not_wide_buffer B>
   ...
   template <bool Checked = true, is_not_wide_buffer B>
   ...
   template <auto c, bool Checked = true, is_not_wide_buffer B>
   ...
   template <string_literal str, bool Checked = true, is_not_wide_buffer B>
   GLZ_ALWAYS_INLINE void dump(B& b, size_t& ix) noexcept(not vector_like<B>)
   {
   ...
   template <auto c, is_not_wide_buffer B>
   ...
   template <char IndentChar, is_not_wide_buffer B>
   ...
   template <const sv& str, bool Checked = true, is_not_wide_buffer B>
   ...
   template <size_t N, is_not_wide_buffer B>
